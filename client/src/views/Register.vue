<template lang="html">
  <v-container>
    ...
    <v-text-field label="Password" type="password" placeholder="Password" autocomplete="new-password" :value="registerPassword" @input="setRegisterPassword"></v-text-field>
